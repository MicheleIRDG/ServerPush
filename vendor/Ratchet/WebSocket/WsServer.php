...
require_once "vendor/Ratchet/ConnectionInterface.php";
require_once "vendor/Ratchet/MessageComponentInterface.php";
require_once "vendor/Ratchet/Http/HttpServerInterface.php";
require_once "vendor/Ratchet/Http/CloseResponseTrait.php";
require_once "vendor/psr/src/RequestInterface.php";
require_once "vendor/Ratchet/Messaging\MessageInterface.php";
require_once "vendor/Ratchet/Messaging/FrameInterface.php";
require_once "vendor/Ratchet/Messaging/Frame.php";
require_once "vendor/Ratchet/Messaging/MessageBuffer.php";
require_once "vendor/Ratchet/Messaging/CloseFrameChecker.php";
require_once "vendor/Ratchet/Handshake/ServerNegotiator.php";
require_once "vendor/Ratchet/Handshake/RequestVerifier.php";
require_once "vendor/react/event-loop/src/LoopInterface.php";
require_once "vendor/Ratchet/WebSocket/WsConnection.php";
require_once "vendor/Ratchet/WebSocket/ConnContext.php";
